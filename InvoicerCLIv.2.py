...
finalCount = {'POTATO MIDS': None , 'MUSHROOM CUP': None, 'CAULIFLOWER': None, 'GARLIC PEELED X 1kg': None, 'LETTUCE CRUNCHY MIX X 250 GM': None, 'LETTUCE EUROPA SALAD X 500G': None,
'WASHED BABY MIXED LEAF': None, 'CORIANDER LOOSE X 100G': None, 'BROCCOLI': None,'CARROT': None, 'PEPPER GREEN':None, 'PEPPER RED': None, 'PEPPER YELLOW': None}
def pushToDictionary(targetDictionary, key, value):
...
#         3- The new value you want to add to the dictionary. NOTE:function expects a list as value.\n
#         4- The index of the list \n

#         This function should only be used to update dictionaries.

#         #TODO convert this function to update any kind of data structures.
#         """
...
#                 if item in row: # item is the name of the item
...
for item in extractedCsv:
        if item in PRODUCTS:
                ...
                pushToDictionary(finalCount, item, extractedCsv[index] )
